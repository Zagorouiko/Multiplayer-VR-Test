...
public class NetManager : MonoBehaviour
{
    ...
    public void OnJoinedRoom()
    {
        ...
        PhotonNetwork.Instantiate(handPrefab.name, ViveManager.Instance.head.transform.position,
            ViveManager.Instance.head.transform.rotation, 0);
        PhotonNetwork.Instantiate(handPrefab.name, ViveManager.Instance.leftHand.transform.position,
            ViveManager.Instance.leftHand.transform.rotation, 0);
        PhotonNetwork.Instantiate(handPrefab.name, ViveManager.Instance.rightHand.transform.position,
